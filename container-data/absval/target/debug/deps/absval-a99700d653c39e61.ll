; ModuleID = 'absval.8ktvm719-cgu.0'
...
@alloc4 = private unnamed_addr constant <{ i8*, [16 x i8] }> <{ i8* getelementptr inbounds (<{ [75 x i8] }>, <{ [75 x i8] }>* @alloc3, i32 0, i32 0, i32 0), [16 x i8] c"K\00\00\00\00\00\00\00n\00\00\00\05\00\00\00" }>, align 8
...
define internal zeroext i1 @"_ZN4core3num21_$LT$impl$u20$i64$GT$11is_negative17hf0376ece24bd8f91E"(i64 %self) unnamed_addr #0 !dbg !385 {
start:
  %self.dbg.spill = alloca i64, align 8
  store i64 %self, i64* %self.dbg.spill, align 8
  call void @llvm.dbg.declare(metadata i64* %self.dbg.spill, metadata !394, metadata !DIExpression()), !dbg !395
  %0 = icmp slt i64 %self, 0, !dbg !396
  ret i1 %0, !dbg !397
}

; core::num::<impl i64>::abs
; Function Attrs: inlinehint nounwind nonlazybind
define internal i64 @"_ZN4core3num21_$LT$impl$u20$i64$GT$3abs17hfc75190d6d3c6ed3E"(i64 %self) unnamed_addr #1 !dbg !398 {
start:
  %self.dbg.spill = alloca i64, align 8
  %0 = alloca i64, align 8
  store i64 %self, i64* %self.dbg.spill, align 8
  call void @llvm.dbg.declare(metadata i64* %self.dbg.spill, metadata !402, metadata !DIExpression()), !dbg !403
; call core::num::<impl i64>::is_negative
  %_2 = call zeroext i1 @"_ZN4core3num21_$LT$impl$u20$i64$GT$11is_negative17hf0376ece24bd8f91E"(i64 %self), !dbg !404
  br i1 %_2, label %bb2, label %bb3, !dbg !405

bb2:                                              ; preds = %start
  %_5 = icmp eq i64 %self, -9223372036854775808, !dbg !406
  %1 = call i1 @llvm.expect.i1(i1 %_5, i1 false), !dbg !406
  br i1 %1, label %panic, label %bb4, !dbg !406

bb3:                                              ; preds = %start
  store i64 %self, i64* %0, align 8, !dbg !407
  br label %bb5, !dbg !405

bb4:                                              ; preds = %bb2
  %2 = sub i64 0, %self, !dbg !406
  store i64 %2, i64* %0, align 8, !dbg !406
  br label %bb5, !dbg !405

bb5:                                              ; preds = %bb3, %bb4
  %3 = load i64, i64* %0, align 8, !dbg !408
  ret i64 %3, !dbg !408
...
; absval::absolute_test
; Function Attrs: nounwind nonlazybind
define internal void @_ZN6absval13absolute_test17h7d5e28b1776dc5c9E(i64 %a) unnamed_addr #2 !dbg !438 {
start:
  %a.dbg.spill = alloca i64, align 8
  store i64 %a, i64* %a.dbg.spill, align 8
  call void @llvm.dbg.declare(metadata i64* %a.dbg.spill, metadata !444, metadata !DIExpression()), !dbg !445
; call core::num::<impl i64>::abs
  %_4 = call i64 @"_ZN4core3num21_$LT$impl$u20$i64$GT$3abs17hfc75190d6d3c6ed3E"(i64 %a), !dbg !446
  %_3 = icmp sge i64 %_4, 0, !dbg !446
...
start:
  ...
  call void @llvm.dbg.declare(metadata i64* %x, metadata !453, metadata !DIExpression()), !dbg !455
  store i64 6, i64* %x, align 8, !dbg !456
...
; call cstr_core::CStr::from_bytes_with_nul_unchecked
  ...
  store i64* %x, i64** %t.dbg.spill.i, align 8, !noalias !477
  call void @llvm.dbg.declare(metadata i64** %t.dbg.spill.i, metadata !480, metadata !DIExpression()) #11, !dbg !492
  ...
  %_3.i = bitcast i64* %x to i8*, !dbg !495
; call cstr_core::CStr::as_ptr
  ...
  call void @klee_make_symbolic(i8* %_3.i, i64 8, i8* %_6.i) #11, !dbg !497
  %_12 = load i64, i64* %x, align 8, !dbg !498
; call absval::absolute_test
  call void @_ZN6absval13absolute_test17h7d5e28b1776dc5c9E(i64 %_12), !dbg !499
  ret void, !dbg !500
}
...
define internal void @_ZN4core9panicking5panic17h07405d6be4bce887E([0 x i8]* noalias nonnull readonly align 1 %0, i64 %1, %"core::panic::Location"* noalias readonly align 8 dereferenceable(24) %2) unnamed_addr #5 !dbg !501 {
  ...
  call void @llvm.lifetime.start.p0i8(i64 48, i8* nonnull %6), !dbg !505
  %7 = bitcast [1 x { [0 x i8]*, i64 }]* %4 to i8*, !dbg !506
  call void @llvm.lifetime.start.p0i8(i64 16, i8* nonnull %7), !dbg !506
...
define internal void @_ZN4core9panicking9panic_fmt17hcd56f7f635f62c74E(%"fmt::Arguments"* noalias nocapture dereferenceable(48) %0, %"core::panic::Location"* noalias readonly align 8 dereferenceable(24) %1) unnamed_addr #5 !dbg !519 {
  ...
  call void @llvm.lifetime.start.p0i8(i64 32, i8* nonnull %4), !dbg !520
...
!10 = !DIFile(filename: "/home/ubuntu/.cargo/registry/src/github.com-1ecc6299db9ec823/cstr_core-0.2.5/src/lib.rs", directory: "/home/ubuntu/container-data/container-data/absval/target/debug/deps")
!11 = !{!12, !20, !29}
...
!60 = !DIFile(filename: "/home/ubuntu/.cargo/registry/src/github.com-1ecc6299db9ec823/cty-0.2.2/src/lib.rs", directory: "/home/ubuntu/container-data/container-data/absval/target/debug/deps")
...
!62 = !DIFile(filename: "/home/ubuntu/.cargo/git/checkouts/klee-sys-7ee2aa8a1a6bbc46/9f462cc/src/lib.rs", directory: "/home/ubuntu/container-data/container-data/absval/target/debug/deps")
...
!64 = !DIFile(filename: "/home/ubuntu/.cargo/registry/src/github.com-1ecc6299db9ec823/memchr-2.4.1/src/lib.rs", directory: "/home/ubuntu/container-data/container-data/absval/target/debug/deps")
...
!381 = !DIFile(filename: "/home/ubuntu/.cargo/git/checkouts/panic-klee-aa8d015442188497/3b0c897/src/lib.rs", directory: "/home/ubuntu/container-data/container-data/absval/target/debug/deps")
!382 = !{!20, !12}
...
!385 = distinct !DISubprogram(name: "is_negative", linkageName: "_ZN4core3num21_$LT$impl$u20$i64$GT$11is_negative17hf0376ece24bd8f91E", scope: !387, file: !386, line: 1768, type: !389, scopeLine: 1768, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !4, templateParams: !6, retainedNodes: !393)
...
!392 = !DIBasicType(name: "i64", size: 64, encoding: DW_ATE_signed)
!393 = !{!394}
...
!398 = distinct !DISubprogram(name: "abs", linkageName: "_ZN4core3num21_$LT$impl$u20$i64$GT$3abs17hfc75190d6d3c6ed3E", scope: !387, file: !386, line: 1701, type: !399, scopeLine: 1701, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !4, templateParams: !6, retainedNodes: !401)
...
!415 = !{!416}
!416 = !DISubrange(count: -1, lowerBound: 0)
...
!438 = distinct !DISubprogram(name: "absolute_test", linkageName: "_ZN6absval13absolute_test17h7d5e28b1776dc5c9E", scope: !440, file: !439, line: 8, type: !441, scopeLine: 8, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !4, templateParams: !6, retainedNodes: !443)
!439 = !DIFile(filename: "src/main.rs", directory: "/home/ubuntu/container-data/absval", checksumkind: CSK_MD5, checksum: "45b0e616dd327e5d1b62cc8d3fd3ec8c")
...
!451 = !{null}
!452 = !{!453}
!453 = !DILocalVariable(name: "x", scope: !454, file: !439, line: 14, type: !392, align: 8)
...
!477 = !{!478}
!478 = distinct !{!478, !479, !"_ZN8klee_sys17lib_klee_analysis18klee_make_symbolic17h885449dc2f2dd4a9E: %name.0"}
!479 = distinct !{!479, !"_ZN8klee_sys17lib_klee_analysis18klee_make_symbolic17h885449dc2f2dd4a9E"}
!480 = !DILocalVariable(name: "t", arg: 1, scope: !481, file: !482, line: 17, type: !487)
!481 = distinct !DISubprogram(name: "klee_make_symbolic<i64>", linkageName: "_ZN8klee_sys17lib_klee_analysis18klee_make_symbolic17h885449dc2f2dd4a9E", scope: !483, file: !482, line: 17, type: !485, scopeLine: 17, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !4, templateParams: !490, retainedNodes: !488)
...
!486 = !{null, !487, !419}
!487 = !DIDerivedType(tag: DW_TAG_pointer_type, name: "&mut i64", baseType: !392, size: 64, align: 64, dwarfAddressSpace: 0)
!488 = !{!480, !489}
...
!577 = !{!578}
!578 = !DISubrange(count: 3, lowerBound: 0)
